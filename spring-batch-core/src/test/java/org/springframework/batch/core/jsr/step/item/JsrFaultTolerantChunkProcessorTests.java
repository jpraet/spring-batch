...
public class JsrFaultTolerantChunkProcessorTests {
	...
	public void testSkipWriteError() throws Exception{
		...
		assertEquals(7, listener.onSkipInWrite);
	}
	...
	public static class CountingListener implements ItemReadListener<String>, ItemProcessListener<String, String>, ItemWriteListener<String>, SkipListener<String, String> {
